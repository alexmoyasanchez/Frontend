...
class HomeController extends ChangeNotifier {
  ...
  void createMarkers(int num) {
    ...
    LatLng pepe2 = new LatLng(41.279730, 1.983748); //Residencia universitaria EETAC
    LatLng pepe3 = new LatLng(41.2735649, 1.9799459); //Residencia universitaria EETAC
    LatLng pepe4 = new LatLng(41.2724051, 1.9721655); //Residencia universitaria EETAC
