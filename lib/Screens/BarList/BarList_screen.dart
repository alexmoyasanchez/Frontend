...
Future<Bar> getBar(String id) async {
  final data =
      await http.get(Uri.parse('http://147.83.7.157:3000/bares/getBar/' + id));
...
Future<List<Valoracion>> getValoraciones(String idBar) async {
  ...
  final data = await http.get(Uri.parse(
      'http://147.83.7.157:3000/valoraciones/getValoracionesByBar/' + idBar));
  var jsonData = json.decode(data.body);
  for (var u in jsonData) {
    print(data.body);
...
Future<Bar> enviarOpinion(
  ...
  final data = await http.post(
    Uri.parse('http://147.83.7.157:3000/valoraciones/new/'),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=UTF-8',
    },
    body: jsonEncode(<String, String>{
...
Future<Bar> eliminarValoracion(String id) async {
  final data = await http.delete(
    Uri.parse('http://147.83.7.157:3000/valoraciones/delete/' + id),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=UTF-8',
    },
    body: jsonEncode(<String, String>{}),
